            ...
            return `
                <tr>
                    ...
                    <td>
                        ${item.빌딩명 || '-'}
                        ${pdfStatus.available ? 
                            `<span class="badge bg-${pdfStatusClass} ms-1" title="${pdfTitle}">PDF</span>` 
                            : ''
                        }
                    </td>
                    <td>${item.주소 || '-'}</td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">
                                ${item.빌딩명} 
                                <span class="badge bg-secondary">PDF 없음</span>
                            </h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-sm">
                                        <tr><td><strong>빌딩명</strong></td><td>${item.빌딩명 || '-'}</td></tr>
                                        <tr><td><strong>주소</strong></td><td>${item.주소 || '-'}</td></tr>
                                        <tr><td><strong>인근역</strong></td><td>${item.인근역 || '-'}</td></tr>
                                        <tr><td><strong>출처회사</strong></td><td>${item.출처회사 || '-'}</td></tr>
                                    </table>
                                </div>
                                <div class="col-md-6">
                                    <h6>공실 정보</h6>
                                    <table class="table table-sm">
                                        <tr><td><strong>공실층</strong></td><td>${item.공실층 || '-'}</td></tr>
                                        <tr><td><strong>공실면적</strong></td><td>${item['공실전용면적(평)'] || '-'}평</td></tr>
                                        <tr><td><strong>기준층면적</strong></td><td>${item.기준층전용면적 || '-'}평</td></tr>
                                    </table>
                                </div>
                            </div>
                            <div class="alert alert-info">
                                <i class="bi bi-info-circle"></i>
                                해당 빌딩의 PDF 자료가 준비되지 않았습니다. 
                                자세한 정보는 ${item.출처회사}에 문의하세요.
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" 
                                    onclick="MapManager.showBuildingMap(${DataManager.currentResults.indexOf(item)})">
